        ...
        while True:
            ...
            for insertion_idx1 in group_ct_map1.keys():
                for insertion_idx2 in group_ct_map1.keys():
                    ...
                    cost -= 2 * group_ct_map1[insertion_idx1]

                    # f1.f1.f1.f1 is canceled out
                    # -f0.f2.f2.r1.(f0.f0.f1.f2.f2)
                    cost -= 4 * group_ct_map2[insertion_idx1]
                    ...
                    cost -= 2 * group_ct_map1[insertion_idx2]

                    # f0.f0.f0.f0 and f2.f2.f2.f2 are canceled out
                    # -f0.f2.f2.r1.-f1
                    cost -= 4 * group_ct_map2[insertion_idx2]
...
evaluate_parser.add_argument("-d", "--debug", action="store_true")
